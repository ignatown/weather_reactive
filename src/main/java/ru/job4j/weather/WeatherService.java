...
public class WeatherService {
...

    {
        ...
        weathers.put(7, new Weather(7, "Ryazan", 25));
    }
    ...
    public Flux<Weather> greatThen(int temp) {
        return Flux.fromIterable(weathers.values().stream().filter(c -> c.getTemperature() > temp)
